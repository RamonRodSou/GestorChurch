...
import UserData from '@components/dashboard/pages/user-data/UserData';
import UserDetails from '@components/dashboard/pages/user-data/user-details/UserDetails';
import UserInvited from '@components/dashboard/pages/user-data/user-invited/UserInvited';
                ...
                {!user ? (
                    ...
                    <>
                        <Route path="/dashboard/:userId" element={<ProtectedRoute><Dashboard /></ProtectedRoute>}>
                            ...
                            <Route path="/dashboard/:userId/edit-report-group/:reportId" element={<ReportGroupDetails />} />
